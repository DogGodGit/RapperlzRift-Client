...
////// Lighting:
////// Emissive:
                float2 node_2874 = (float2((i.uv0.b+i.uv1.r),(i.uv0.a+i.uv1.g))+i.uv1.b);
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(node_2874, _MainTex));
