...
// #define FRAGMENT_SETUP_CLIP(x) FragmentCommonData x = \
	// FragmentSetupCustom(i.tex, i.eyeVec, IN_VIEWDIR4PARALLAX(i), i.tangentToWorldAndPackedData, IN_WORLDPOS_CLIP(i));
...
half4 fragForwardClipBaseInternal (VertexOutputForwardClipBase i)
{
	...
	//FragmentCommonData s = FragmentSetup(i.tex, i.eyeVec, IN_VIEWDIR4PARALLAX(i), i.tangentToWorldAndPackedData, IN_WORLDPOS_CLIP(i));
...
half4 fragForwardClipAddInternal(VertexOutputForwardClipAdd i)
{
	...
	//FragmentCommonData s = FragmentSetup(i.tex, i.eyeVec, IN_VIEWDIR4PARALLAX_FWDADD(i), i.tangentToWorldAndLightDir, IN_WORLDPOS_FWDADD_CLIP(i));
	PLANE_CLIP(s.posWorld)
