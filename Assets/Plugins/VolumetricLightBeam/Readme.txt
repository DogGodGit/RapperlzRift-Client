...
- Due to a bug in Unity, Texture3D (and so the 3D Noise feature) are not working in Editor with WebGL set as the current platform. But the Noise 3D works totally fine in the browser if you export a WebGL build...
