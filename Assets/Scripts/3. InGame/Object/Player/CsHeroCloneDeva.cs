...
public class CsHeroCloneDeva : CsHeroClone
{
	static AudioClip s_aclDead;
	static AudioClip s_aclDamage;
	static AudioClip s_acILevelUp;
	...
	{
		CsEffectHeroDeva.Instance.PlaySoundDamage(m_audioSource);
	}
