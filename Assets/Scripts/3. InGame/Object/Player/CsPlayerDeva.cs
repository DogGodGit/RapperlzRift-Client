...
public class CsPlayerDeva : CsMyPlayer
{
	//---------------------------------------------------------------------------------------------------
	protected override void Start()
	{
		base.Start();
		Debug.Log("CsPlayerDeva.Start()");
	...
	{
		//CsIngameData.Instance.InGameCamera.DoAiming(true, 0.5f, 1.6f);
	}
	...
	protected override void OnEventMyHeroLevelUp()
	{
		...
		CsEffectHeroDeva.Instance.PlaySoundLevelUp(m_audioSourceParent);
	}

	//---------------------------------------------------------------------------------------------------
	protected override void DamgaeSound(int nSkill)
	{
		CsEffectHeroDeva.Instance.PlaySoundDamage(m_audioSourceParent);
	}
