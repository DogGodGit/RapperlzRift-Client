...
public abstract class GameServerCommand
{
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Constants
    ...
    protected GameServerResponse m_response = null;
    ...
    public GameServerCommand(string sCommand)
    {
        m_sCommand = sCommand;
    }
    ...
    public virtual GameServerResponse response
    {
    ...
    protected virtual void Finish(int nResult, GameServerResponse response, Exception error)
    {
    ...
    protected abstract GameServerResponse CreateResponse();
