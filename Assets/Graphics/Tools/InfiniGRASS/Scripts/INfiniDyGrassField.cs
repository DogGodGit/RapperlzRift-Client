					...
					if(Interactive_tree){
						...
						if(Forest_holder1 == null | Forest_holder1.Length < 1){
							...
							for(int i=0;i<Forest_holder1.Length;i++){
								...
								//if(Enter & Combiner.Added_item_count < Combiner.Max_items &  Combiner.Max_items == Max_interact_holder_items  
						...
						if(Forest_holder1 == null | Forest_holder1.Length < 1){
							...
							for(int i=0;i<Forest_holder1.Length;i++){
								...
								//if(Enter & Combiner.Added_item_count < Combiner.Max_items &  Combiner.Max_items == Max_trees_per_group 
								//   & (!GroupByObject | (GroupByObject))){
...
//							}
							...
							if(Tree_status_previous != Interactive_tree)
							{
						...
						if(Rot_toward_normal & growth_over){
...
//									}
			...
			if (!Interactive_tree && Application.isPlaying && Disable_after_growth && Combiner != null) {
				...
				if ( All_growing_ended && (!WhenCombinerFull1 || (WhenCombinerFull1)) ) {
