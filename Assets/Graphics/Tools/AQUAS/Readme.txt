...
ATTENTION:
The minimum Unity version for AQUAS 1.4 is Unity 5.6!
If you're using a previous Unity version, please use AQUAS 1.3.1 (available for download from the asset store).
