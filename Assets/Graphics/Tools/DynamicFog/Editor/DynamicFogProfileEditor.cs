...
namespace DynamicFogAndMist
{
	...
	public class DynamicFogProfileEditor : Editor
	{
		...
		static GUIContent[] FOG_TYPE_OPTIONS = new GUIContent[] { new GUIContent ("Desktop Fog Plus + Sky Haze"), 
		...
		static int[] FOG_TYPE_VALUES = new int[] { (int)FOG_TYPE.DesktopFogPlusWithSkyHaze,
