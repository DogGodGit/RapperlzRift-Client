...
namespace DynamicFogAndMist
{
	public enum FOG_TYPE
	{
		...
		MobileFogWithSkyHaze = 1, // 그래픽팀 사용중
	...
	static class FOG_TYPE_Ext
	{
		...
		{
			return fogType == FOG_TYPE.DesktopFogPlusWithSkyHaze || fogType == FOG_TYPE.MobileFogSimple || fogType == FOG_TYPE.MobileFogBasic ||
																	fogType == FOG_TYPE.MobileFogOrthogonal || fogType == FOG_TYPE.DesktopFogPlusOrthogonal;
		}
	}
