...
//				}
                ...
                //fixed3 fcol = _LightColor0.xyz *  tex2D(_Diffuse, i.uv0);
                //UNITY_APPLY_FOG_COLOR(i.fogCoord,  fcol, fixed4(0,0.372f,0.678f, 1)); // fog towards black due to our blend mode

                fixed4 fcol = fixed4(finalColor * _Color  + specular* _SpecularPower * _LightColor0.xyz, _Alpha);
