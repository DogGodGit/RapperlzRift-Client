...
public class CsNavToObj : MonoBehaviour
{
    ...
    static void Export()
    {
		...
		string filename = Application.dataPath + "/(Temporary)/" + Path.GetFileNameWithoutExtension(EditorApplication.currentScene) + " Exported NavMesh.obj";
